...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("mibs")
  );

  if (!record) { console.error("Could not find MIBS Group!"); process.exit(1); }
...
<head>
  ...
  <title>MIBS Group — Office Locations</title>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #imi-map { width: 100%; height: 350px; background: #ffffff; }
